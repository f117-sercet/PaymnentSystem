...
import com.pay.pay.core.model.params.xxpay.XxpayNormalMchParams;
...
public abstract class NormalMchParams {
    ...
    public static NormalMchParams factory(String ifCode, String paramsStr){
        ...
        if(CS.IF_CODE.WXPAY.equals(ifCode)){
            return JSONObject.parseObject(paramsStr, (Type) WxpayNormalMchParams.class);
        }else if(CS.IF_CODE.ALIPAY.equals(ifCode)){
            return JSONObject.parseObject(paramsStr, (Type) AlipayNormalMchParams.class);
            ...
            return JSONObject.parseObject(paramsStr, (Type) PpPayNormalMchParams.class);
        }
        return null;
    }
