...
import com.pay.pay.core.model.params.ysf.YsfpayIsvParams;
...
public abstract class IsvParams {
    ...
    public static IsvParams factory(String ifCode, String paramsStr){
        ...
        if(CS.IF_CODE.WXPAY.equals(ifCode)){
            return JSONObject.parseObject(paramsStr, (Type) WxpayIsvParams.class);
        }else if(CS.IF_CODE.ALIPAY.equals(ifCode)){
            return JSONObject.parseObject(paramsStr, (Type) AlipayIsvParams.class);
        }else if(CS.IF_CODE.YSFPAY.equals(ifCode)){
            return JSONObject.parseObject(paramsStr, (Type) YsfpayIsvParams.class);
        }
        return null;
    }
