 ...
 *
 * @author: 段世超
 * @aate: Created in 2023/11/14 11:05
 */
@Data
@AllArgsConstructor
public class WxServiceWrapper {
    ...
    public static WxServiceWrapper buildWxServiceWrapper(
            String mchId, String appId, String appSecret,
            String mchKey, String apiVersion, String apiV3Key,
            String serialNo, String cert, String apiClientCert,
            String apiClientKey
    ) {
