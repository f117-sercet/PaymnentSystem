...
/**
 * Description： 支付平台 获取系统文件工具类
 *
 * @author: 段世超
 * @aate: Created in 2023/11/14 11:09
 */
@Component
public class ChannelCertConfigKitBean {
    ...
    public File getCertFile(String certFilePath){
        ...
        File file = downloadFile(certFilePath, certFile);
